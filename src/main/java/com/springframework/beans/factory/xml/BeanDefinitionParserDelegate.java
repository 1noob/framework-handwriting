...
import com.springframework.beans.BeanMetadataAttribute;
...
import com.springframework.util.xml.DomUtils;
...
//	关键就在与 DefaultNamespaceHandlerResolver 是如何找到该命名空间对应的 NamespaceHandler 处理器，
//	我们只是在 spring.handlers 文件中进行关联，它是怎么找到的呢，我们进入 DefaultNamespaceHandlerResolver 看看
