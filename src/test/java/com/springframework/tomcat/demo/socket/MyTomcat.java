package com.springframework.tomcat.demo.socket;


import com.springframework.tomcat.demo.MyHttpServlet;
...
public class MyTomcat {
    ...
    private void init() {
        try {
            //获取web.xml目录地址
            String path = MyTomcat.class.getResource("/web/").getPath();
            //实例化SAXReader对象
        ...
        } catch (DocumentException | ClassNotFoundException | MalformedURLException | IllegalAccessException | InstantiationException e) {
            e.printStackTrace();
        }
    }
